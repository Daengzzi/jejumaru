...
public class AdminNoticeController {
    ...
    @GetMapping("/admin_notice/admin_notice_list")
...
//    // Update
//    @GetMapping("/admin_notice/{nno}/admin_notice_update")
//    public String updateForm(@PathVariable int nno, Model model ) {
//        model.addAttribute("notice", noticeService.글상세보기(nno));
//        return "admin_notice/admin_notice_update" ;
//    }
//
//
//    // Insert
//    @GetMapping("/admin_notice/admin_notice_write")
//    public String saveForm() {
//        return "admin_notice/admin_notice_write";
//    }
}
