...
class AdminQnaBody extends Component {
    state = {
        isLoading: true,
        groups: []
    };
                ...
                if(group.qanswer == null) {
                    return <tr>
                        ...
                        <td className="col-p7 daoTitle"><Link
                            to={"/admin/qna/detail/" + group.qno}>{group.qtitle}</Link></td>
...
export default withRouter(AdminQnaBody);