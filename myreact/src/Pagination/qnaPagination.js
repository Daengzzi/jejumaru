...
import QnaBody from '../QnA/qnaBody';

class QnaPagination extends Component{
        ...
        return (
            <>
                <table className="tab">
                    ...
                    <Route path="/jejumaru/qna/page/:page" component={withRouter(QnaBody)}/>
                </table>
...
export default withRouter(QnaPagination);
