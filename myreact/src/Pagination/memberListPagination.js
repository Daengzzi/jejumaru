...
import adminMemberListBody from "../Admin/Member/adminMemberListBody";

class MemberListPagination extends Component{
    ...
    render() {
        ...
        return (
            <>
                <Route path="/admin/member/page/:page" component={withRouter(adminMemberListBody)}/>
...
export default withRouter(MemberListPagination);
