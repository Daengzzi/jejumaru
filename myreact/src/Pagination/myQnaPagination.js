...
import MyQnaBody from '../QnA/myQnaBody';
import AuthService from "../services/authService";

class MyQnaPagination extends Component{
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <>
                <table className="tab">
                    ...
                    <Route path="/jejumaru/myqna/page/:page" component={withRouter(MyQnaBody)}/>
                </table>
...
export default withRouter(MyQnaPagination);
