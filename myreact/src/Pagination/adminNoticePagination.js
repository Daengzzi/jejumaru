...
import NoticeBody from '../Admin/Notice/adminNoticeBody';

class AdminNoticePagination extends Component{
        ...
        return (
            <>
                <table>
                    ...
                    <Route path="/admin/notice/page/:page" component={withRouter(NoticeBody)}/>
                </table>
...
export default withRouter(AdminNoticePagination);
