...
class AdminNoticeBody extends Component {
    state = {
        isLoading: true,
        groups: []
    };
        ...
        return(
            groups.content.map(group =>
                    <tr>
                        ...
                        <td className="col-p7 daoTitle"><Link to={"/admin/notice/detail/"+group.nno}>{group.ntitle}</Link></td>
...
export default withRouter(AdminNoticeBody);